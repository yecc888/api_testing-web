  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="项目名称：">
            <el-input v-model="listQuery.keyword" class="input-width" placeholder="项目名称" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button   type="primary"
        ...
        @click="handleAdd()" style="margin-left: 20px">添加项目</el-button>
    </el-card>
    ...
    <el-table
      ...
      <el-table-column prop="brandName" min-width="160" label="项目名称" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="busFormatName" min-width="160" label="项目编号" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorName" min-width="150" label="项目开始日期" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorName" min-width="150" label="项目结束结束" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorName" min-width="150" label="项目描述" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorName" min-width="150" label="项目成员" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorTime" min-width="200" label="更新时间" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="operatorTime" min-width="200" label="项目创建时间" show-overflow-tooltip align="center"></el-table-column>
